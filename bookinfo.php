...
var prev = 0;
var next =0;
// var idStr = "isset($_GET['idStr']) ? $_GET['idStr'] : "";"
// if(chaidArray.length > 0){
//   if(chaid < chaidArray[0]) chaidArray.unshift(chaid);
//   if(chaid > chaidArray[chaidArray.length-1]) chaidArray.push(chaid);
// }else{
//   chaidArray[0] = chaid;
// }
