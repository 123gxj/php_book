...
//查询数据
$catelist = $db->select("cate.*,cate.name")->from("cate")->orderby("cate.id","desc")->limit($start,$limit)->all();
            ...
            <div class="row-fluid">
                ...
                <div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <p class="error-text"><i class="icon-warning-sign modal-icon"></i>确认删除分类?</p>
                    </div>
